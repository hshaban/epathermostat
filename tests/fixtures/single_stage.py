...
def metrics_type_1_data():
    ...
    data = [
        ...
        },
        {
            ...
            "mu_estimate_daily": 12.43826441383452,
            "sigma_estimate_daily": 28.767897596209746,
            "sigmoid_model_error_daily": 0.035242504682036734,
            "aux_exceeds_heat_runtime_daily": False,
            "dnru_hourly": 0.2247928980896961,
            "dnru_reduction_hourly": 0.14563136215168795,
            "mu_estimate_hourly": 12.186647680245548,
            "sigma_estimate_hourly": 28.494683093126646,
            "sigmoid_model_error_hourly": 0.057688602252931785,
