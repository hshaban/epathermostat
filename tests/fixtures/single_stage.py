...
def metrics_type_1_data():
    ...
    data = [
        ...
        },
        {
            ...
            'mu_estimate_daily': 5.582356190152692,
            'sigma_estimate_daily': 36.455748895919754,
            'sigmoid_model_error_daily': 0.314289622860835,
            'sigmoid_integral_daily': 3.2822529891612473,
            "aux_exceeds_heat_runtime_daily": False,
            "dnru_hourly": 0.2247928980896961,
            "dnru_reduction_hourly": 0.14563136215168795,
            'mu_estimate_hourly': -4.657658506920492,
            'sigma_estimate_hourly': 46.95964227604139,
            'sigmoid_model_error_hourly': 0.7233459029302405,
            'sigmoid_integral_hourly': 2.9361078088595747,
