...
def metrics_ert_hpeb_2_hp_2_data():
    data = [
        ...
        },
        {
            ...
            'mu_estimate_daily': 23.51168942757289,
            'sigma_estimate_daily': 3.151952095469693,
            'sigmoid_model_error_daily': 0.03554090833355643,
            'aux_exceeds_heat_runtime_daily': True,
            'dnru_hourly': 0.049357181761880725,
            'dnru_reduction_hourly': 0.3344944124890115,
            'mu_estimate_hourly': -0.2797021433361735,
            'sigma_estimate_hourly': 0.8819060044961713,
            'sigmoid_model_error_hourly': 0.031595530474213825,
