...
def metrics_hpeb_2_hp_2_data():
    ...
    data = [
        ...
        },
        {
            ...
            'mu_estimate_daily': 23.403856671971116,
            'sigma_estimate_daily': 3.045447284449576,
            'sigmoid_model_error_daily': 0.033883859112506735,
            'aux_exceeds_heat_runtime_daily': True,
            'dnru_hourly': 0.0466793667182617,
            'dnru_reduction_hourly': 0.33630312696984904,
            'mu_estimate_hourly': -0.2852522336516188,
            'sigma_estimate_hourly': 0.9003573067894823,
            'sigmoid_model_error_hourly': 0.030511131254224316,
