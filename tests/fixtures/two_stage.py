...
def metrics_hpeb_2_hp_2_data():
    ...
    data = [
        ...
        },
        {
            ...
            'mu_estimate_daily': 23.393954087519145,
            'sigma_estimate_daily': 3.018940937667638,
            'sigmoid_model_error_daily': 0.18674963258909189,
            'sigmoid_integral_daily': 4.679005901651551,
            "aux_exceeds_heat_runtime_daily": True,
            "dnru_hourly": 0.0466793667182617,
            "dnru_reduction_hourly": 0.33630312696984904,
            'mu_estimate_hourly': 1.32994649993775,
            'sigma_estimate_hourly': 18.038325330431963,
            'sigmoid_model_error_hourly': 0.06857491947250308,
            'sigmoid_integral_hourly': 1.5710229011257564,
